...
impl Unit {
    ...
    pub const MARAUDER: Self = Self::new(
        ...
        125,
        0,
        [Some(Weapon::MARAUDER), None, None],
        Armor::new(1, 0),
